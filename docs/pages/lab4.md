...
<div style="display: flex; justify-content: center; align-items: flex-start; gap: 10px;">
  <div style="text-align: center;">
    ...
    <img src="../images/lab4/Top_View_Labeled.svg" alt="Top View" style="height: 300px; width: auto;">
  </div>
  <div style="text-align: center;">
    <h3 style="margin-bottom: 6px; margin-top: 0;">Bottom View</h3>
    <img src="../images/lab4/Bottom_View_Labeled.svg" alt="Bottom View" style="height: 300px; width: auto;">
  </div>
</div>
