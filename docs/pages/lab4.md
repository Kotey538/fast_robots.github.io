...
<div style="display: flex; justify-content: center; align-items: flex-start; gap: 12px;">
  <div style="flex: 1; text-align: center;">
    <h3 style="all: unset; display: block; font-size: 1.17em; font-weight: bold; margin-bottom: 4px; text-align: center;">Top View</h3>
    <img src="../images/lab4/Top_View_Labeled.svg" alt="Top View" style="height: 400px; width: auto;">
  </div>
  <div style="flex: 1; text-align: center;">
    <h3 style="all: unset; display: block; font-size: 1.17em; font-weight: bold; margin-bottom: 4px; text-align: center;">Bottom View</h3>
